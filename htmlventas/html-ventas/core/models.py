...
class Compra(models.Model):
    ...
    idAutor = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.PROTECT,verbose_name='Autor')
    class Meta:
        db_table = 'compra'

    
    def __str__(self) : #Python 3 
        return self.idCurso.titulo +'   ' + 'Creado por ' + self.idAutor.username 
